...
def add_objects_to_l3(l3_mos, xpos=None, ypos=None, coords=None, coords_unit='rad', wcs=None, psf=None, rng=None, seed=None):
    ...
    for idx, (x, y) in enumerate(zip(xpos_idx, ypos_idx)):
        ...
        romanisim.image.add_objects_to_image(sourcecounts, [source_cat[idx]], xpos=[xpos[idx]],
                                             ypos=[ypos[idx]], psf=psf, flux_to_counts_factor=Ct,
