...
The ``romanisim-make-l3`` command-line interface can be used to make L3 files.  
...
The function :meth:`romanisim.l3.inject_sources_into_l3` is the intended entry point for L3 simulations.  Invocations look like::
